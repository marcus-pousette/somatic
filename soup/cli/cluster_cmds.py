...
Thin argument-parsing skin over `soup.cluster` (Cluster + teardown_run). All
...
from soup.cluster import Cluster, teardown_run
from soup.cluster.errors import ClusterError
from soup.cluster.hosts import parse_hosts
...
def cluster_verify(
    ...
    from soup.cluster.errors import ClusterError
    from soup.cluster.verify import DEFAULT_PROMPTS, verify
...
def cluster_provision(
    ...
    from soup.cluster.provision import provision
...
def cluster_bench(
    ...
    from soup.cluster.bench import benchmark
    from soup.cluster.errors import ClusterError
