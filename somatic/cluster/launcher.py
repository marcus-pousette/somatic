"""`from somatic import Cluster` — the one object behind the CLI, the SDK, and the UI.
...
from somatic.cluster.capacity import LaunchPlan
from somatic.cluster.hosts import Host, coerce_hosts
from somatic.cluster.runstate import RunRecord
from somatic.cluster.supervisor import Supervisor, build_plan
...
class Cluster:
    ...
    def openai(self):
        ...
        return openai.OpenAI(base_url=self.openai_base_url, api_key="somatic")
