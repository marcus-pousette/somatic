...
from somatic.sequence_model.boundary_compression.sparse_codebook_wire import (
...
from somatic.sequence_model.boundary_compression.boundary_wire_lossless import (
