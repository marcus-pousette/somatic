...
from somatic.runtime.schemas import utc_now


PROVIDER_PROBE_ENDPOINT_PATH = "/.well-known/somatic/public-worker-security/probe"
PROVIDER_STARTUP_OBSERVATION_ENDPOINT_PATH = (
    "/.well-known/somatic/public-worker-security/startup-observation"
)
